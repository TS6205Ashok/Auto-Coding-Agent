...
- What this project does: Build A Customer Portal is a 100% runnable starter project built around React + FastAPI. Fast Mode uses backend templates for all standard project structure so output quality stays complete while generation remains fast.
- Tech stack used:
- Language: Python
- Frontend: React
- Backend: FastAPI
...
- Project name: Build A Customer Portal
- Generated version: Project Agent Generated Starter v1
...
- Problem statement handled by this starter: Build a customer portal
