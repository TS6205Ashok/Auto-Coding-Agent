# Design A Small Puzzle

Design A Small Puzzle is a fully playable sliding puzzle starter built with plain HTML, CSS, and JavaScript. Fast Mode keeps the project dependency-free so it can run immediately by opening index.html or using the provided run scripts.
